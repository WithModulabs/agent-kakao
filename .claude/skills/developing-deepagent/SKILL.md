...
allowed-tools:
  ...
  - AskUserQuestion
---
# Developing Kakao Emoticon's DeepAgent

Implement DeepAgent components using the `deepagents` SDK within Kakao Emoticon Act patterns.
...
```bash
uv add --package kakao-emoticon deepagents
```
