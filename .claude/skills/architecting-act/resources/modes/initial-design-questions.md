...
2. Check cookiecutter template values (act name: Kakao Emoticon, cast name: Convert)
...
**Condition**:
- Skip if: Cast name already provided by cookiecutter template (Convert)
...
```json
{
  "question": "I see you created a cast called 'Convert'. What should this cast accomplish?",
...
```json
{
  "question": "What is the main goal of Convert Cast?",
  "header": "Cast Goal",
  "options": [
