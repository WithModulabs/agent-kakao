...
# Architecting Kakao Emoticon Act
...
**Steps:**
1. **Kakao Emoticon Act Questions** → [modes/initial-design-questions.md](./resources/modes/initial-design-questions.md)
...
**Steps:**
1. **Read CLAUDE.md** → Understand existing Kakao Emoticon Act and Casts
